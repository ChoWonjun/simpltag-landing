      ...
      <section className="section" id="about">
        <div className="wrap">
          ...
          <article className="about-block">
            ...
            <p>
              다만 1인 프로젝트로 다룰 수 있는 데이터와 사용자의 폭에는 한계가 있었고, 여기서 생긴
              갈증을 실제 서비스의 규모 위에서 풀어보고 싶다는 바람이 점점 커졌습니다. 7년간 기획자로
              일하며 쌓아 온 경험에 직접 만들며 익힌 기술적 이해를 더해, 더 많은 사람이 믿고 맡길 수 있는
              AI 경험을 만드는 일에 기여하고 싶습니다.
            </p>
          </article>
          ...
          <article className="about-block">
            ...
            <p>
              1인 환경에서 다듬어 온 이 방식이, 기획자가 직접 만들며 문제를 푸는 새로운 일하는 방식에
              작은 보탬이 될 수 있도록 노력하겠습니다.
            </p>
          </article>
        </div>
      </section>
